...
export default function BookCard({ title, cover, author, description, purchaseLink }) {
    ...
    return (
        <div className="group perspective w-full" style={{ perspective: '2000px' }}>
            <div
                className="relative transform-style-preserve-3d transition-all duration-500 ease-out hover:rotate-y-30 hover:scale-105 hover:shadow-2xl cursor-pointer"
